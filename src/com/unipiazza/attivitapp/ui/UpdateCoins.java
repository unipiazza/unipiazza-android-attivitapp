...
public class UpdateCoins extends Activity {
	...
	public String updateJSONdata() {
        ...
        Log.v("value ", "Il saldo di " + user + " con id_utente = " + id + " nell'attivita con ID " + id_attivita + " aggiornato di " + saldo + " | Il gift è " + gift_value + " | Id prodotto = " + gift_id );
        try {
        	JSONObject json = jsonParser.makeHttpRequest(URL_BALANCE,"POST", params);
        	Log.d("Messaggio: ", json.getString(TAG_MESSAGE));
        	int success = json.getInt(TAG_SUCCESS);
        	if (success==1){
        		Log.d("Coins Inseriti/sottratti!", json.getString(TAG_COINS));
