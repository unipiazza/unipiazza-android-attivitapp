...
import com.example.unipiazza.JSONParser;
...
public class MainActivity extends Activity {
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(final String result) {
            if (result != null) {
            	Button btnSearchId;
            	setContentView(R.layout.activity_main_tapped);
            	mTextView.setText("Utente di Nome : " + result);
               	btnSearchId = (Button) findViewById(R.id.btnHomeId);                
                btnSearchId.setOnClickListener(new View.OnClickListener() {
        			@Override
        			public void onClick(View view) {
        			    Intent i = new Intent(getBaseContext(), searchID.class);
        			    i.putExtra("new_variable_name",result);
        			    startActivity(i);
        			}
        		 });
            }
