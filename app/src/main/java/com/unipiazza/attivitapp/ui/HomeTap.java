...
import com.unipiazza.attivitapp.AttivitAppApplication;
...
public class HomeTap extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NdefMessage msg = new NdefMessage(
                new NdefRecord[]{NdefRecord.createMime(UnipiazzaParams.NFC_DEVICE_MIMETYPE, null)});
        ...
        CurrentShop.getInstance().isAuthenticated(HomeTap.this, new HttpCallback() {
            ...
            public void onSuccess(JsonObject result) {
                ...
                ((AttivitAppApplication) getApplication()).startPing();
            }
    ...
    private void handleIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action) ||
            ...
            NdefMessage msg = (NdefMessage) (rawMsgs != null ? rawMsgs[0] : null);
            if (rawMsgs != null
                ...
                edit19.commit();
                searchId(null, tag_id_string);
            } else {
                Tag tag = intent.getParcelableExtra(NfcAdapter.EXTRA_TAG);
                Log.v("value ", "TAG Preso : " + tag);
                byte[] tag_id = tag.getId();
                tag_id_string = bytesToHex(tag_id);
                Log.i("tag ID", tag_id_string);
                Log.i("tag ID Appena preso", tag_id_string);
                SharedPreferences sp19 = PreferenceManager
                        .getDefaultSharedPreferences(HomeTap.this);
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(final String tag) {
            if (tag != null) {
                ...
                searchId(tag_id_string, null);
            }
        }
    }

    private void searchId(String hash_pass, String user_id) {
