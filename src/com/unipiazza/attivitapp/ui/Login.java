...
public class Login extends Activity implements OnClickListener {
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			//Internet presente quindi:
				try {
					...
					if (success == 1) {
						...
						SharedPreferences sp6 = PreferenceManager.getDefaultSharedPreferences(Login.this);
						Editor edit6 = sp6.edit();
						edit6.putString("id_attivita", id_attivita);
						edit6.commit();
						Intent i = new Intent(Login.this, HomeTap.class);
						((UnipiazzaApp)getApplication()).setLoggato(true);
						Log.d("value", "Login attivitï¿½ " + username + " con id_attivita = " + id_attivita + " avvenuto con successo!!");
						finish();
						startActivity(i);
			...
			//Se arrivito qua, vuol dire che internet non è attivo
		...
		protected void onPostExecute(String file_url) {
			...
			if (internet==false)
				Toast.makeText(Login.this, "Non c'è connessione ad internet =(\r\nRiprova fra qualche minuto!", Toast.LENGTH_SHORT).show();
		}
