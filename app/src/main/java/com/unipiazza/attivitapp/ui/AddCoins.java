...
public class AddCoins extends Activity implements OnClickListener {
    ...
    private static final int STANDARD_NUM_KEYBOARD = 0;
    private static final int TOSHL_STYLE_NUM_KEYBOARD = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sp.getBoolean("toshl_style_keyboard", true)) {
            currentKeyboard = 1;
    ...
    private class BtnListener implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (currentKeyboard == STANDARD_NUM_KEYBOARD) {
            ...
            } else if (currentKeyboard == TOSHL_STYLE_NUM_KEYBOARD) {
                if (inStr.length() > 5) // Dimensione max cifra = 5
                    return;
                String euro = NumberFormat.getCurrencyInstance().getCurrency().getSymbol();
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            case R.id.send_products:
                if (inStr.equals("0") || inStr.equals("00") || inStr.startsWith("0,0")) // Valore inserito = 0 o minore di 10cents
                {
